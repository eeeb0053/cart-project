...
import { AccountUpdateOrDeleteForm, ChangePassWord } from 'container/index';
import {
...
import AccountSettingWrapper, {
  ...
  AgentName,
  FromWrapper,
} from 'container/user/MyPage/AccountSettings/AccountSettings.style';
...
const AccountSettingRoute = (props) => {
  ...
  return (
    <FromWrapper>
      <Route exact path={`${match.path}`} component={AccountUpdateOrDeleteForm} />
      <Route
